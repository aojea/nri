...
type NetworkSetupRequest struct {
	...
	// The sandbox ID. Network hooks operate at the Pod boundary, not the
	// container boundary.
	...
	// Pod annotations passed down from CRI.
	// Essential for dynamic triggers (for example Service Mesh injection
	// without mutating disk files).
	Annotations map[string]string `protobuf:"bytes,3,rep,name=annotations,proto3" json:"annotations,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	// Accumulated state from previous plugins in the setup pipeline.
	CurrentInterfaces []*NetworkInterface `protobuf:"bytes,4,rep,name=current_interfaces,json=currentInterfaces,proto3" json:"current_interfaces,omitempty"`
}

func (x *NetworkSetupRequest) Reset() {
	*x = NetworkSetupRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *NetworkSetupRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*NetworkSetupRequest) ProtoMessage() {}

func (x *NetworkSetupRequest) ProtoReflect() protoreflect.Message {
	mi := &file_pkg_api_api_proto_msgTypes[66]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use NetworkSetupRequest.ProtoReflect.Descriptor instead.
func (*NetworkSetupRequest) Descriptor() ([]byte, []int) {
	return file_pkg_api_api_proto_rawDescGZIP(), []int{66}
}

func (x *NetworkSetupRequest) GetPodSandboxId() string {
	if x != nil {
		return x.PodSandboxId
	}
	return ""
...
func (x *NetworkSetupRequest) GetNetnsPath() string {
	if x != nil {
		return x.NetnsPath
	}
	return ""
...
func (x *NetworkSetupRequest) GetAnnotations() map[string]string {
	if x != nil {
		return x.Annotations
	}
	return nil
...
func (x *NetworkSetupRequest) GetCurrentInterfaces() []*NetworkInterface {
	if x != nil {
		return x.CurrentInterfaces
	}
	return nil
}
...
type NetworkSetupResponse struct {
	...
	// The plugin returns the total updated state of interfaces.
	Interfaces []*NetworkInterface `protobuf:"bytes,1,rep,name=interfaces,proto3" json:"interfaces,omitempty"`
}

func (x *NetworkSetupResponse) Reset() {
	*x = NetworkSetupResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *NetworkSetupResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*NetworkSetupResponse) ProtoMessage() {}

func (x *NetworkSetupResponse) ProtoReflect() protoreflect.Message {
	mi := &file_pkg_api_api_proto_msgTypes[67]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use NetworkSetupResponse.ProtoReflect.Descriptor instead.
func (*NetworkSetupResponse) Descriptor() ([]byte, []int) {
	return file_pkg_api_api_proto_rawDescGZIP(), []int{67}
}

func (x *NetworkSetupResponse) GetInterfaces() []*NetworkInterface {
	if x != nil {
		return x.Interfaces
	}
	return nil
...
type NetworkTeardownRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	NetnsPath    string            `protobuf:"bytes,2,opt,name=netns_path,json=netnsPath,proto3" json:"netns_path,omitempty"`
	Annotations  map[string]string `protobuf:"bytes,3,rep,name=annotations,proto3" json:"annotations,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	// If teardown is triggered due to rollback, this contains the safe
	// accumulated state of interfaces created prior to the failure.
	CurrentInterfaces []*NetworkInterface `protobuf:"bytes,4,rep,name=current_interfaces,json=currentInterfaces,proto3" json:"current_interfaces,omitempty"`
}

func (x *NetworkTeardownRequest) Reset() {
	*x = NetworkTeardownRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *NetworkTeardownRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*NetworkTeardownRequest) ProtoMessage() {}

func (x *NetworkTeardownRequest) ProtoReflect() protoreflect.Message {
	mi := &file_pkg_api_api_proto_msgTypes[68]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use NetworkTeardownRequest.ProtoReflect.Descriptor instead.
func (*NetworkTeardownRequest) Descriptor() ([]byte, []int) {
	return file_pkg_api_api_proto_rawDescGZIP(), []int{68}
}

func (x *NetworkTeardownRequest) GetPodSandboxId() string {
	if x != nil {
		return x.PodSandboxId
	}
	return ""
...
func (x *NetworkTeardownRequest) GetNetnsPath() string {
	if x != nil {
		return x.NetnsPath
	}
	return ""
...
func (x *NetworkTeardownRequest) GetAnnotations() map[string]string {
	if x != nil {
		return x.Annotations
	}
	return nil
...
func (x *NetworkTeardownRequest) GetCurrentInterfaces() []*NetworkInterface {
	if x != nil {
		return x.CurrentInterfaces
	}
	return nil
...
type NetworkTeardownResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
}

func (x *NetworkTeardownResponse) Reset() {
	*x = NetworkTeardownResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *NetworkTeardownResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*NetworkTeardownResponse) ProtoMessage() {}

func (x *NetworkTeardownResponse) ProtoReflect() protoreflect.Message {
	mi := &file_pkg_api_api_proto_msgTypes[69]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use NetworkTeardownResponse.ProtoReflect.Descriptor instead.
func (*NetworkTeardownResponse) Descriptor() ([]byte, []int) {
...
type NetworkCheckRequest struct {
	...
	PodSandboxId       string              `protobuf:"bytes,1,opt,name=pod_sandbox_id,json=podSandboxId,proto3" json:"pod_sandbox_id,omitempty"`
	NetnsPath          string              `protobuf:"bytes,2,opt,name=netns_path,json=netnsPath,proto3" json:"netns_path,omitempty"`
	ExpectedInterfaces []*NetworkInterface `protobuf:"bytes,3,rep,name=expected_interfaces,json=expectedInterfaces,proto3" json:"expected_interfaces,omitempty"`
}

func (x *NetworkCheckRequest) Reset() {
	*x = NetworkCheckRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *NetworkCheckRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*NetworkCheckRequest) ProtoMessage() {}

func (x *NetworkCheckRequest) ProtoReflect() protoreflect.Message {
	mi := &file_pkg_api_api_proto_msgTypes[70]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use NetworkCheckRequest.ProtoReflect.Descriptor instead.
func (*NetworkCheckRequest) Descriptor() ([]byte, []int) {
	return file_pkg_api_api_proto_rawDescGZIP(), []int{70}
}

func (x *NetworkCheckRequest) GetPodSandboxId() string {
	if x != nil {
		return x.PodSandboxId
	}
	return ""
...
func (x *NetworkCheckRequest) GetNetnsPath() string {
	if x != nil {
		return x.NetnsPath
	}
	return ""
...
func (x *NetworkCheckRequest) GetExpectedInterfaces() []*NetworkInterface {
	if x != nil {
		return x.ExpectedInterfaces
	}
	return nil
}
...
func (x *NetworkCheckResponse) Reset() {
	*x = NetworkCheckResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *NetworkCheckResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*NetworkCheckResponse) ProtoMessage() {}

func (x *NetworkCheckResponse) ProtoReflect() protoreflect.Message {
	mi := &file_pkg_api_api_proto_msgTypes[71]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use NetworkCheckResponse.ProtoReflect.Descriptor instead.
func (*NetworkCheckResponse) Descriptor() ([]byte, []int) {
	return file_pkg_api_api_proto_rawDescGZIP(), []int{71}
}

func (x *NetworkCheckResponse) GetHealthy() bool {
	if x != nil {
		return x.Healthy
	}
	return false
...
func (x *NetworkCheckResponse) GetReason() string {
	if x != nil {
		return x.Reason
	}
	return ""
...
type NetworkInterface struct {
	...
	// The name of the interface created on the host network namespace
	// (for example "veth-pod-1"). The plugin creates this locally on the host.
	HostInterfaceName string `protobuf:"bytes,1,opt,name=host_interface_name,json=hostInterfaceName,proto3" json:"host_interface_name,omitempty"`
	// The desired name of the interface inside the pod (for example "eth0").
	// Runtimes use this mapping to populate the OCI LinuxNetDevice spec,
	// allowing runc/crun to move the interface without plugin nsenter
	// privileges.
	ContainerInterfaceName string   `protobuf:"bytes,2,opt,name=container_interface_name,json=containerInterfaceName,proto3" json:"container_interface_name,omitempty"`
	...
	// Allows plugins to attach opaque data, hardware offload tokens, or eBPF
	// map pins that subsequent plugins might need in the chain.
	ExtensionAttributes map[string]string `protobuf:"bytes,6,rep,name=extension_attributes,json=extensionAttributes,proto3" json:"extension_attributes,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
func (x *NetworkInterface) GetHostInterfaceName() string {
	if x != nil {
...
func (x *NetworkInterface) GetContainerInterfaceName() string {
	if x != nil {
		return x.ContainerInterfaceName
	}
	return ""
}
...
func (x *NetworkInterface) GetRoutes() []*Route {
	if x != nil {
		return x.Routes
	}
	return nil
...
func (x *NetworkInterface) GetExtensionAttributes() map[string]string {
	if x != nil {
...
var file_pkg_api_api_proto_rawDesc = []byte{
	...
	,
	...
	0x52, 0x06, 0x66, 0x61, 0x69, 0x6c, 0x65, 0x64, 0x22, 0xbe, 0x01, 0x0a, 0x0a, 0x4c, 0x6f, 0x67,
	0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x10, 0x0a, 0x03, 0x6d, 0x73, 0x67, 0x18, 0x01,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x6d, 0x73, 0x67, 0x12, 0x3c, 0x0a, 0x05, 0x6c, 0x65, 0x76,
	0x65, 0x6c, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x26, 0x2e, 0x6e, 0x72, 0x69, 0x2e, 0x70,
	0x6b, 0x67, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x76, 0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x31, 0x2e,
	0x4c, 0x6f, 0x67, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x2e, 0x4c, 0x65, 0x76, 0x65, 0x6c,
	0x52, 0x05, 0x6c, 0x65, 0x76, 0x65, 0x6c, 0x22, 0x60, 0x0a, 0x05, 0x4c, 0x65, 0x76, 0x65, 0x6c,
	...
	0x4c, 0x5f, 0x45, 0x52, 0x52, 0x4f, 0x52, 0x10, 0x04, 0x22, 0xf3, 0x01, 0x0a, 0x10, 0x43, 0x6f,
	...
	0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x12, 0x21, 0x0a, 0x0c, 0x72, 0x75, 0x6e, 0x74, 0x69, 0x6d,
	...
	,
	...
	0x20, 0x01, 0x28, 0x05, 0x52, 0x06, 0x65, 0x76, 0x65, 0x6e, 0x74, 0x73, 0x22, 0x9f, 0x01, 0x0a,
	...
	0x63, 0x6f, 0x6e, 0x74, 0x61, 0x69, 0x6e, 0x65, 0x72, 0x73, 0x12, 0x12, 0x0a, 0x04, 0x6d, 0x6f,
	0x72, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x08, 0x52, 0x04, 0x6d, 0x6f, 0x72, 0x65, 0x22, 0x68,
	0x0a, 0x13, 0x53, 0x79, 0x6e, 0x63, 0x68, 0x72, 0x6f, 0x6e, 0x69, 0x7a, 0x65, 0x52, 0x65, 0x73,
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x3d, 0x0a, 0x06, 0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x18,
	0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x25, 0x2e, 0x6e, 0x72, 0x69, 0x2e, 0x70, 0x6b, 0x67, 0x2e,
	...
	0x3a, 0x02, 0x38, 0x01, 0x22, 0xcf, 0x02, 0x0a, 0x13, 0x4e, 0x65, 0x74, 0x77, 0x6f, 0x72, 0x6b,
	0x53, 0x65, 0x74, 0x75, 0x70, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x24, 0x0a, 0x0e,
	...
	0x49, 0x64, 0x12, 0x1d, 0x0a, 0x0a, 0x6e, 0x65, 0x74, 0x6e, 0x73, 0x5f, 0x70, 0x61, 0x74, 0x68,
	0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x6e, 0x65, 0x74, 0x6e, 0x73, 0x50, 0x61, 0x74,
	0x68, 0x12, 0x5c, 0x0a, 0x0b, 0x61, 0x6e, 0x6e, 0x6f, 0x74, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x73,
	0x18, 0x03, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x3a, 0x2e, 0x6e, 0x72, 0x69, 0x2e, 0x70, 0x6b, 0x67,
	0x2e, 0x61, 0x70, 0x69, 0x2e, 0x76, 0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x31, 0x2e, 0x4e, 0x65,
	0x74, 0x77, 0x6f, 0x72, 0x6b, 0x53, 0x65, 0x74, 0x75, 0x70, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73,
	...
	,
	...
	0x72, 0x66, 0x61, 0x63, 0x65, 0x73, 0x22, 0xd5, 0x02, 0x0a, 0x16, 0x4e, 0x65, 0x74, 0x77, 0x6f,
	0x72, 0x6b, 0x54, 0x65, 0x61, 0x72, 0x64, 0x6f, 0x77, 0x6e, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73,
	...
	,
	...
	,
	...
	0x75, 0x74, 0x65, 0x73, 0x1a, 0x46, 0x0a, 0x18, 0x45, 0x78, 0x74, 0x65, 0x6e, 0x73, 0x69, 0x6f,
	...
	,
	...
	,
	...
	,
	...
	0x61, 0x69, 0x6e, 0x65, 0x72, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x68, 0x0a,
	0x0d, 0x53, 0x74, 0x6f, 0x70, 0x43, 0x6f, 0x6e, 0x74, 0x61, 0x69, 0x6e, 0x65, 0x72, 0x12, 0x2a,
	0x2e, 0x6e, 0x72, 0x69, 0x2e, 0x70, 0x6b, 0x67, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x76, 0x31, 0x61,
	0x6c, 0x70, 0x68, 0x61, 0x31, 0x2e, 0x53, 0x74, 0x6f, 0x70, 0x43, 0x6f, 0x6e, 0x74, 0x61, 0x69,
	0x6e, 0x65, 0x72, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x2b, 0x2e, 0x6e, 0x72, 0x69,
	0x2e, 0x70, 0x6b, 0x67, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x76, 0x31, 0x61, 0x6c, 0x70, 0x68, 0x61,
	...
	,
	...
	0x72, 0x69, 0x2e, 0x70, 0x6b, 0x67, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x76, 0x31, 0x61, 0x6c, 0x70,
	0x68, 0x61, 0x31, 0x2e, 0x4e, 0x65, 0x74, 0x77, 0x6f, 0x72, 0x6b, 0x43, 0x68, 0x65, 0x63, 0x6b,
	...
	,
...
var file_pkg_api_api_proto_msgTypes = make([]protoimpl.MessageInfo, 91)
var file_pkg_api_api_proto_goTypes = []interface{}{
	...
	(*NetworkSetupRequest)(nil),                 // 76: nri.pkg.api.v1alpha1.NetworkSetupRequest
	(*NetworkSetupResponse)(nil),                // 77: nri.pkg.api.v1alpha1.NetworkSetupResponse
	(*NetworkTeardownRequest)(nil),              // 78: nri.pkg.api.v1alpha1.NetworkTeardownRequest
	(*NetworkTeardownResponse)(nil),             // 79: nri.pkg.api.v1alpha1.NetworkTeardownResponse
	(*NetworkCheckRequest)(nil),                 // 80: nri.pkg.api.v1alpha1.NetworkCheckRequest
	(*NetworkCheckResponse)(nil),                // 81: nri.pkg.api.v1alpha1.NetworkCheckResponse
	(*NetworkInterface)(nil),                    // 82: nri.pkg.api.v1alpha1.NetworkInterface
	(*Route)(nil),                               // 83: nri.pkg.api.v1alpha1.Route
	nil,                                         // 84: nri.pkg.api.v1alpha1.PodSandbox.LabelsEntry
	nil,                                         // 85: nri.pkg.api.v1alpha1.PodSandbox.AnnotationsEntry
	nil,                                         // 86: nri.pkg.api.v1alpha1.Container.LabelsEntry
	nil,                                         // 87: nri.pkg.api.v1alpha1.Container.AnnotationsEntry
	nil,                                         // 88: nri.pkg.api.v1alpha1.LinuxContainer.SysctlEntry
	nil,                                         // 89: nri.pkg.api.v1alpha1.LinuxContainer.NetDevicesEntry
	nil,                                         // 90: nri.pkg.api.v1alpha1.LinuxResources.UnifiedEntry
	nil,                                         // 91: nri.pkg.api.v1alpha1.ContainerAdjustment.AnnotationsEntry
	nil,                                         // 92: nri.pkg.api.v1alpha1.LinuxContainerAdjustment.SysctlEntry
	nil,                                         // 93: nri.pkg.api.v1alpha1.LinuxContainerAdjustment.NetDevicesEntry
	nil,                                         // 94: nri.pkg.api.v1alpha1.CompoundFieldOwners.OwnersEntry
	nil,                                         // 95: nri.pkg.api.v1alpha1.FieldOwners.SimpleEntry
	nil,                                         // 96: nri.pkg.api.v1alpha1.FieldOwners.CompoundEntry
	nil,                                         // 97: nri.pkg.api.v1alpha1.OwningPlugins.OwnersEntry
	nil,                                         // 98: nri.pkg.api.v1alpha1.NetworkSetupRequest.AnnotationsEntry
	nil,                                         // 99: nri.pkg.api.v1alpha1.NetworkTeardownRequest.AnnotationsEntry
	nil,                                         // 100: nri.pkg.api.v1alpha1.NetworkInterface.ExtensionAttributesEntry
}
var file_pkg_api_api_proto_depIdxs = []int32{
	...
	84,  // 32: nri.pkg.api.v1alpha1.PodSandbox.labels:type_name -> nri.pkg.api.v1alpha1.PodSandbox.LabelsEntry
	85,  // 33: nri.pkg.api.v1alpha1.PodSandbox.annotations:type_name -> nri.pkg.api.v1alpha1.PodSandbox.AnnotationsEntry
	...
	86,  // 40: nri.pkg.api.v1alpha1.Container.labels:type_name -> nri.pkg.api.v1alpha1.Container.LabelsEntry
	87,  // 41: nri.pkg.api.v1alpha1.Container.annotations:type_name -> nri.pkg.api.v1alpha1.Container.AnnotationsEntry
	...
	88,  // 62: nri.pkg.api.v1alpha1.LinuxContainer.sysctl:type_name -> nri.pkg.api.v1alpha1.LinuxContainer.SysctlEntry
	89,  // 63: nri.pkg.api.v1alpha1.LinuxContainer.net_devices:type_name -> nri.pkg.api.v1alpha1.LinuxContainer.NetDevicesEntry
	...
	90,  // 76: nri.pkg.api.v1alpha1.LinuxResources.unified:type_name -> nri.pkg.api.v1alpha1.LinuxResources.UnifiedEntry
	...
	91,  // 96: nri.pkg.api.v1alpha1.ContainerAdjustment.annotations:type_name -> nri.pkg.api.v1alpha1.ContainerAdjustment.AnnotationsEntry
	...
	92,  // 109: nri.pkg.api.v1alpha1.LinuxContainerAdjustment.sysctl:type_name -> nri.pkg.api.v1alpha1.LinuxContainerAdjustment.SysctlEntry
	93,  // 110: nri.pkg.api.v1alpha1.LinuxContainerAdjustment.net_devices:type_name -> nri.pkg.api.v1alpha1.LinuxContainerAdjustment.NetDevicesEntry
	...
	94,  // 125: nri.pkg.api.v1alpha1.CompoundFieldOwners.owners:type_name -> nri.pkg.api.v1alpha1.CompoundFieldOwners.OwnersEntry
	95,  // 126: nri.pkg.api.v1alpha1.FieldOwners.simple:type_name -> nri.pkg.api.v1alpha1.FieldOwners.SimpleEntry
	96,  // 127: nri.pkg.api.v1alpha1.FieldOwners.compound:type_name -> nri.pkg.api.v1alpha1.FieldOwners.CompoundEntry
	97,  // 128: nri.pkg.api.v1alpha1.OwningPlugins.owners:type_name -> nri.pkg.api.v1alpha1.OwningPlugins.OwnersEntry
	98,  // 129: nri.pkg.api.v1alpha1.NetworkSetupRequest.annotations:type_name -> nri.pkg.api.v1alpha1.NetworkSetupRequest.AnnotationsEntry
	82,  // 130: nri.pkg.api.v1alpha1.NetworkSetupRequest.current_interfaces:type_name -> nri.pkg.api.v1alpha1.NetworkInterface
	82,  // 131: nri.pkg.api.v1alpha1.NetworkSetupResponse.interfaces:type_name -> nri.pkg.api.v1alpha1.NetworkInterface
	99,  // 132: nri.pkg.api.v1alpha1.NetworkTeardownRequest.annotations:type_name -> nri.pkg.api.v1alpha1.NetworkTeardownRequest.AnnotationsEntry
	82,  // 133: nri.pkg.api.v1alpha1.NetworkTeardownRequest.current_interfaces:type_name -> nri.pkg.api.v1alpha1.NetworkInterface
	82,  // 134: nri.pkg.api.v1alpha1.NetworkCheckRequest.expected_interfaces:type_name -> nri.pkg.api.v1alpha1.NetworkInterface
	83,  // 135: nri.pkg.api.v1alpha1.NetworkInterface.routes:type_name -> nri.pkg.api.v1alpha1.Route
	100, // 136: nri.pkg.api.v1alpha1.NetworkInterface.extension_attributes:type_name -> nri.pkg.api.v1alpha1.NetworkInterface.ExtensionAttributesEntry
	51,  // 137: nri.pkg.api.v1alpha1.LinuxContainer.NetDevicesEntry.value:type_name -> nri.pkg.api.v1alpha1.LinuxNetDevice
	51,  // 138: nri.pkg.api.v1alpha1.LinuxContainerAdjustment.NetDevicesEntry.value:type_name -> nri.pkg.api.v1alpha1.LinuxNetDevice
	73,  // 139: nri.pkg.api.v1alpha1.FieldOwners.CompoundEntry.value:type_name -> nri.pkg.api.v1alpha1.CompoundFieldOwners
	74,  // 140: nri.pkg.api.v1alpha1.OwningPlugins.OwnersEntry.value:type_name -> nri.pkg.api.v1alpha1.FieldOwners
	10,  // 141: nri.pkg.api.v1alpha1.Runtime.RegisterPlugin:input_type -> nri.pkg.api.v1alpha1.RegisterPluginRequest
	11,  // 142: nri.pkg.api.v1alpha1.Runtime.UpdateContainers:input_type -> nri.pkg.api.v1alpha1.UpdateContainersRequest
	14,  // 143: nri.pkg.api.v1alpha1.Plugin.Configure:input_type -> nri.pkg.api.v1alpha1.ConfigureRequest
	16,  // 144: nri.pkg.api.v1alpha1.Plugin.Synchronize:input_type -> nri.pkg.api.v1alpha1.SynchronizeRequest
	30,  // 145: nri.pkg.api.v1alpha1.Plugin.Shutdown:input_type -> nri.pkg.api.v1alpha1.Empty
	18,  // 146: nri.pkg.api.v1alpha1.Plugin.CreateContainer:input_type -> nri.pkg.api.v1alpha1.CreateContainerRequest
	20,  // 147: nri.pkg.api.v1alpha1.Plugin.UpdateContainer:input_type -> nri.pkg.api.v1alpha1.UpdateContainerRequest
	22,  // 148: nri.pkg.api.v1alpha1.Plugin.StopContainer:input_type -> nri.pkg.api.v1alpha1.StopContainerRequest
	24,  // 149: nri.pkg.api.v1alpha1.Plugin.UpdatePodSandbox:input_type -> nri.pkg.api.v1alpha1.UpdatePodSandboxRequest
	76,  // 150: nri.pkg.api.v1alpha1.Plugin.NetworkSetup:input_type -> nri.pkg.api.v1alpha1.NetworkSetupRequest
	78,  // 151: nri.pkg.api.v1alpha1.Plugin.NetworkTeardown:input_type -> nri.pkg.api.v1alpha1.NetworkTeardownRequest
	80,  // 152: nri.pkg.api.v1alpha1.Plugin.NetworkCheck:input_type -> nri.pkg.api.v1alpha1.NetworkCheckRequest
	26,  // 153: nri.pkg.api.v1alpha1.Plugin.StateChange:input_type -> nri.pkg.api.v1alpha1.StateChangeEvent
	27,  // 154: nri.pkg.api.v1alpha1.Plugin.ValidateContainerAdjustment:input_type -> nri.pkg.api.v1alpha1.ValidateContainerAdjustmentRequest
	13,  // 155: nri.pkg.api.v1alpha1.HostFunctions.Log:input_type -> nri.pkg.api.v1alpha1.LogRequest
	30,  // 156: nri.pkg.api.v1alpha1.Runtime.RegisterPlugin:output_type -> nri.pkg.api.v1alpha1.Empty
	12,  // 157: nri.pkg.api.v1alpha1.Runtime.UpdateContainers:output_type -> nri.pkg.api.v1alpha1.UpdateContainersResponse
	15,  // 158: nri.pkg.api.v1alpha1.Plugin.Configure:output_type -> nri.pkg.api.v1alpha1.ConfigureResponse
	17,  // 159: nri.pkg.api.v1alpha1.Plugin.Synchronize:output_type -> nri.pkg.api.v1alpha1.SynchronizeResponse
	30,  // 160: nri.pkg.api.v1alpha1.Plugin.Shutdown:output_type -> nri.pkg.api.v1alpha1.Empty
	19,  // 161: nri.pkg.api.v1alpha1.Plugin.CreateContainer:output_type -> nri.pkg.api.v1alpha1.CreateContainerResponse
	21,  // 162: nri.pkg.api.v1alpha1.Plugin.UpdateContainer:output_type -> nri.pkg.api.v1alpha1.UpdateContainerResponse
	23,  // 163: nri.pkg.api.v1alpha1.Plugin.StopContainer:output_type -> nri.pkg.api.v1alpha1.StopContainerResponse
	25,  // 164: nri.pkg.api.v1alpha1.Plugin.UpdatePodSandbox:output_type -> nri.pkg.api.v1alpha1.UpdatePodSandboxResponse
	77,  // 165: nri.pkg.api.v1alpha1.Plugin.NetworkSetup:output_type -> nri.pkg.api.v1alpha1.NetworkSetupResponse
	79,  // 166: nri.pkg.api.v1alpha1.Plugin.NetworkTeardown:output_type -> nri.pkg.api.v1alpha1.NetworkTeardownResponse
	81,  // 167: nri.pkg.api.v1alpha1.Plugin.NetworkCheck:output_type -> nri.pkg.api.v1alpha1.NetworkCheckResponse
	30,  // 168: nri.pkg.api.v1alpha1.Plugin.StateChange:output_type -> nri.pkg.api.v1alpha1.Empty
	29,  // 169: nri.pkg.api.v1alpha1.Plugin.ValidateContainerAdjustment:output_type -> nri.pkg.api.v1alpha1.ValidateContainerAdjustmentResponse
	30,  // 170: nri.pkg.api.v1alpha1.HostFunctions.Log:output_type -> nri.pkg.api.v1alpha1.Empty
...
func file_pkg_api_api_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_pkg_api_api_proto_msgTypes[66].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*NetworkSetupRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_pkg_api_api_proto_msgTypes[67].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*NetworkSetupResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_pkg_api_api_proto_msgTypes[68].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*NetworkTeardownRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_pkg_api_api_proto_msgTypes[69].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*NetworkTeardownResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_pkg_api_api_proto_msgTypes[70].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*NetworkCheckRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_pkg_api_api_proto_msgTypes[71].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*NetworkCheckResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
