...
func (p *PluginPlugin) Load(ctx context.Context, pluginPath string, hostFunctions HostFunctions) (plugin, error) {
	...
	networksetup := module.ExportedFunction("plugin_network_setup")
	if networksetup == nil {
		return nil, errors.New("plugin_network_setup is not exported")
	}
	networkteardown := module.ExportedFunction("plugin_network_teardown")
	if networkteardown == nil {
		return nil, errors.New("plugin_network_teardown is not exported")
	}
	networkcheck := module.ExportedFunction("plugin_network_check")
	if networkcheck == nil {
		return nil, errors.New("plugin_network_check is not exported")
	}
	...
	return &pluginPlugin{
		...
		networkteardown:             networkteardown,
...
type pluginPlugin struct {
	...
	networksetup                api.Function
	networkteardown             api.Function
	networkcheck                api.Function
...
func (p *pluginPlugin) NetworkSetup(ctx context.Context, request *NetworkSetupRequest) (*NetworkSetupResponse, error) {
	data, err := request.MarshalVT()
	if err != nil {
		return nil, err
	}
	...
	ptrSize, err := p.networksetup.Call(ctx, dataPtr, dataSize)
	if err != nil {
		return nil, err
	}
	...
	response := new(NetworkSetupResponse)
	if err = response.UnmarshalVT(bytes); err != nil {
		return nil, err
	}
...
func (p *pluginPlugin) NetworkTeardown(ctx context.Context, request *NetworkTeardownRequest) (*NetworkTeardownResponse, error) {
	data, err := request.MarshalVT()
	if err != nil {
		return nil, err
	}
	...
	ptrSize, err := p.networkteardown.Call(ctx, dataPtr, dataSize)
	if err != nil {
		return nil, err
	}
	...
	response := new(NetworkTeardownResponse)
	if err = response.UnmarshalVT(bytes); err != nil {
		return nil, err
	}
...
func (p *pluginPlugin) NetworkCheck(ctx context.Context, request *NetworkCheckRequest) (*NetworkCheckResponse, error) {
	data, err := request.MarshalVT()
	if err != nil {
		return nil, err
	}
	...
	ptrSize, err := p.networkcheck.Call(ctx, dataPtr, dataSize)
	if err != nil {
		return nil, err
	}
	...
	response := new(NetworkCheckResponse)
	if err = response.UnmarshalVT(bytes); err != nil {
		return nil, err
	}
